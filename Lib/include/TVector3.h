...
namespace SG {
    ...
    public:
        ...
        double Dot(TVector3 &rhs) { return X * rhs.X + Y * rhs.Y + Z * rhs.Z; }
        ...
        TVector3 Cross(TVector3 rhs) {
            return TVector3<T>(this->Y * rhs.Z - this->Z * rhs.Y,
        ...
        void operator+=(TVector3 const &Another) { this = this + Another; }
        ...
        bool operator!=(const TVector3 &Rhs) const { return !(Rhs == *this); }
