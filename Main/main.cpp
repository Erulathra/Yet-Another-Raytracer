...
int main(int argc, char *argv[]) {
    ...
    {
        SG::TMat4<double> Multiply1 = MatTest1 * MatTest2;
        std::cout << "Multiply Matrix 1 by Matrix 2: " << std::endl;
        std::cout << MatTest1 * MatTest2 << std::endl;

        SG::TMat4<double> Multiply2 = MatTest2 * MatTest1;
    ...
    std::cout << MatTest1 * SG::TMat4<double>::Translation(1, 2, 3) << std::endl;

    std::cout << "Scaling Matrix 1 by [1, 2, 3]: " << std::endl;
    std::cout << MatTest1 * SG::TMat4<double>::Scale(1, 2, 3) << std::endl;
